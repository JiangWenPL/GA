...
#ifdef LOSE_LOST
    int Protect_1 =
        Origin_Protect_1 * (int)pow(Alpha, (double)(pPlayer->A_Level - 1));
    int Protect_2 =
        Origin_Protect_2 * (int)pow(Alpha, (double)(pPlayer->A_Level - 1));
    int Protect_3 =
        Origin_Protect_3 * (int)pow(Alpha, (double)(pPlayer->A_Level - 1));
